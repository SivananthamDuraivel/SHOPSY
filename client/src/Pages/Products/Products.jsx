...
const Products = () => {
  ...
  const addToCart=async(e,id,availableUnit)=>{
    ...
    {
      window.alert("Enter a lesser quantity");return;
    }
    try{
            ...
            <div key={index} className="card">
              ...
              <div className="card-details">
                ...
                <form onSubmit={(e)=>addToCart(e,product._id,product.availableUnit)} >
                  <input type="number" placeholder='enter the quantity' onChange={(e) => setQuantity(e.target.value)} value={quantity} required />
